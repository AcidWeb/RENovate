...
L["Display mission cost"] = "Показать стоимость миссии"
L["Display notifications about new missions"] = "Отображать уведомления о новых миссиях"
L["Mission dispatch"] = "Отправка на миссию"
L["Mission list"] = "Список миссий"
L["Use improved follower panel"] = "Используйте улучшенную панель для соратников"
